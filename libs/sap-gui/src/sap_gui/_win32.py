"""COM connection to a running SAP GUI instance (Windows only)."""
...
class SAPSession:
    ...
    def __init__(
        ...
        *,
        ...
        if auto_launch or connection_string:
            log.warning(
                "auto_launch/connection_string are not supported on Windows — "
                "SAP GUI must already be running"
            )
